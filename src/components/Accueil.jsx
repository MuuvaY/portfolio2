...
function Accueil() {
  ...
  useLayoutEffect(() => {
    let ctx = gsap.context(() => {
      ...
      // Animation de l'image et des liens
      ...
      // Animation de la description et du titre secondaire
  ...
  return (
    <div className="accueil" ref={componentRef}>
