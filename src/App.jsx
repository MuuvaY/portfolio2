              ...
              <div className="carrousel__num">
                <div className="carroussel__slider">
                  <div className="carrousel__titre">
                    <h1 className="carrousel__num-titre">01</h1>
                    <h1 className="carrousel__num-nom">Beez2Be</h1>
                  </div>

                  <div className="carrousel__content">
                    <p className="carrousel__content-p">
                      Dans le cadre d'un projet de 2ème année en groupe, nous
                      avons développé un site web fictif dédié à un food truck.
                      Le site a été conçu en utilisant les langages HTML, CSS,
                      PHP, et Javascript. Mon rôle spécifique a été la création
                      de la page de commande. Cette section du site offre la
                      possibilité de réserver un repas pour une date et une
                      heure spécifiques. Pour plus d'informations, vous pouvez
                      consulter le code sur mon GitHub.
                    </p>
                    <img src={logo} alt="" />
                  </div>
          ...
          <div className="carrousel__container">
            <div className="carrousel__num-content">
              <div className="carrousel__num">
                <div className="carroussel__slider">
                  <div className="carrousel__titre">
                    <h1 className="carrousel__num-titre1 slide-in-right">
                      {slides[currentSlide].titre.split("").map((char, idx) => (
                        <span key={idx}>{char}</span>
                      ))}
                    </h1>
                    <h1 className="carrousel__num-nom1">
                      {slides[currentSlide].nom.split("").map((char, idx) => (
                        <span key={idx}>{char}</span>
                      ))}
                    </h1>
                  </div>
          ...
          <div className="carrousel__container">
            <div className="carrousel__num-content">
              <div className="carrousel__num">
                <div className="carroussel__slider">
                  <div className="carrousel__titre">
                    <h1 className="carrousel__num-titre">
                      <span>0</span>
